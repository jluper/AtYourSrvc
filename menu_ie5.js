...
function openSubMenu(mid) {
	...
	//build submenu items
	sn='<table id="subtable-'+mid+'" cellpadding=0 cellspacing='+sbSIZE+' border=0 style="filter:alpha(opacity=65)\;position:relative\;left:'+shy+'px\;top:'+shy+'px\;'+bks[4]+'">';
	shAry = new Array;
	chAry = new Array;
...
function openChildMenu(mid,cid) {
	...
	cn = '';
	cn+='<table id="childtable-'+mid+'-'+cid+'" cellpadding=0 cellspacing='+sbSIZE+' border=0 style="filter:alpha(opacity=65)\;position:relative\;left:'+shy+'px\;top:'+shy+'px\;'+bks[4]+'">';
	chAry[mid] = new Array;
